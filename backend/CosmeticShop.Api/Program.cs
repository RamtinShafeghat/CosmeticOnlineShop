...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Velora Cosmetic Shop API", Version = "v1" });
...
const string CorsPolicy = "AngularClients";
...
using (var scope = app.Services.CreateScope())
{
    ...
    await DbSeeder.SeedAsync(db, adminSeed);
}
